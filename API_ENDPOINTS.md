...
Base URL: `https://backend-production-0150.up.railway.app`
...
- Allowed origins: 
  ...
  - `https://backend-production-0150.up.railway.app` (backend)
  - `https://dohblog.vercel.app` (frontend deployment)
...
- **Success Response**:
  ...
  - **Content**:
    ...
    {
      "count": 10,
      "next": "https://backend-production-0150.up.railway.app/api/posts/?page=2",
      "previous": null,
      "results": [
        {
          "id": 1,
