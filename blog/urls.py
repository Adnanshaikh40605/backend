...
urlpatterns = [
    ...
    re_path(r'^comments/approved-for-post/$', views.approved_comments_for_post, name='comments-approved-for-post-regex'),
    ...
    path('public-test/', views.public_test, name='public-test'),
] 